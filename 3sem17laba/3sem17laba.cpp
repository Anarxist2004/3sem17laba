...
// 3sem17laba.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMy3sem17labaApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CMy3sem17labaApp::OnAppAbout)
...
// Создание CMy3sem17labaApp

CMy3sem17labaApp::CMy3sem17labaApp() noexcept
{
	...
	SetAppID(_T("My3sem17laba.AppID.NoVersion"));

	// TODO: добавьте код создания,
	// Размещает весь важный код инициализации в InitInstance
}

// Единственный объект CMy3sem17labaApp

CMy3sem17labaApp theApp;


// Инициализация CMy3sem17labaApp

BOOL CMy3sem17labaApp::InitInstance()
{
	...
	pDocTemplate = new CSingleDocTemplate(
		IDR_MAINFRAME,
		RUNTIME_CLASS(CMy3sem17labaDoc),
		RUNTIME_CLASS(CMainFrame),       // основное окно рамки SDI
		RUNTIME_CLASS(CMy3sem17labaView));
	if (!pDocTemplate)
		return FALSE;
...
int CMy3sem17labaApp::ExitInstance()
{
...
// Обработчики сообщений CMy3sem17labaApp
...
void CMy3sem17labaApp::OnAppAbout()
{
